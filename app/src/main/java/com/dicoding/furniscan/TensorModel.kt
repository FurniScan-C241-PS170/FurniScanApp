...
class TensorModel(private val context: Context, private val modelName: String) {
    ...
    private var imageSizeX: Int = 224 // sesuaikan dengan ukuran input model Anda
    private var imageSizeY: Int = 224 // sesuaikan dengan ukuran input model Anda
    ...
    fun runModelOnImage(bitmap: Bitmap): Array<FloatArray> {
